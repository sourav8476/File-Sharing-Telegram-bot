...
SHORTLINK_API_URL = os.environ.get("SHORTLINK_API_URL", "vercel-url-shortener.vercel.app")
# SHORTLINK_API_KEY = os.environ.get("SHORTLINK_API_KEY", "")
#use this key if not working ☠️ (jokin!!)
SHORTLINK_API_KEY = os.environ.get("SHORTLINK_API_KEY", "OEBEoPpRh9FZIiN6LpGNf-OO80k5il37")
